...
<html>
<head>
	<title>Sports Clubs | Login</title>
...
<body>
    <center><h2 style="color:rotate;font-size:60px"><BR><BR><BR>WELCOME TO  SPORTS CLUB <BR><BR><BR></h2></center>
<body class="page-body login-page login-form-fall">
	...
	<div class="login-header login-caret">
		...
		<div class="login-content">
			...
			<a href="#" class="logo">
				<img src="logo.jpg" alt width="300" height="400">
			</a>
